...
% Z = zeros(1500,1500);
% i=1;
% for td = linspace(3000,80000,1500)
%     j=1;
%     for ttf = linspace(3000,80000,1500)
%         Z(j,i)=DelV_LambRend_tdttf(startOrbit,targetOrbit,[td;ttf]);
%         j=j+1;
%     end
%     i=i+1;
% end
% contour(linspace(3000,80000,1500)/60,linspace(3000,80000,1500)/60,Z,30);
...
Z = zeros(1500,1500);
i=1;
for td = linspace(300,20000,1500)
    j=1;
    for ttf = linspace(3000,20000,1500)
        Z(j,i)=DelV_LambRend_tdttf(startOrbit,targetOrbit,[td;ttf]);
        j=j+1;
    end
    i=i+1;
end
contour(linspace(300,20000,1500),linspace(3000,20000,1500),Z,40);
